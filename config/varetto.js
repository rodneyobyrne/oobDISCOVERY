export const varettoConfig = {
  clientId: "varetto",
  clientLabel: "Varetto",
  questionnaireVersion: "varetto-2026-08-v1",
  intro: {
    ...
    purpose: "The goal is not to build a long list of everything Varetto could technically offer. I’m looking for patterns: people you understand well, situations where a strong therapeutic relationship tends to develop, work where you repeatedly see progress, boundaries that matter, and the language people use before they have clinical terminology for what they are experiencing."
  },
  archetypes: [
